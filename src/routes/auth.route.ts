...
/**
 * @swagger
 * /api/v1/auth/create-employee Employee account:
 *   post:
 ...
 *     description: Initiates Google OAuth 2.0 login. Redirects the user to the Google consent screen. No request body is required.
 *     tags:
 *       - Authentication
 *     responses:
 *       200:
